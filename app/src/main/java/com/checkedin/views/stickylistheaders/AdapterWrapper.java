...
/**
 * A {@link ListAdapter} which wraps a {@link StickyListHeadersListView.StickyListHeadersAdapter} and
 * automatically handles wrapping the result of
 * {@link StickyListHeadersListView.StickyListHeadersAdapter#getView(int, View, ViewGroup)}
 * and
 * {@link StickyListHeadersListView.StickyListHeadersAdapter#getHeaderView(int, View, ViewGroup)}
 * appropriately.
 * 
 * @author Jake Wharton (jakewharton@gmail.com)
 */
class AdapterWrapper extends BaseAdapter implements StickyListHeadersListView.StickyListHeadersAdapter {

    interface OnHeaderClickListener {
        public void onHeaderClick(View header, int itemPosition, long headerId);
    }

    final StickyListHeadersListView.StickyListHeadersAdapter mDelegate;
    ...
    AdapterWrapper(Context context, StickyListHeadersListView.StickyListHeadersAdapter delegate) {
        mContext = context;
        mDelegate = delegate;
