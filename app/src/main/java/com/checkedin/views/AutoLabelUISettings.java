...
public class AutoLabelUISettings implements Parcelable {
	...
	public static final int DEFAULT_ICON_CROSS = R.drawable.ic_cancel;
	...
	public static final class Builder {
		...
		private int bTextSize = R.dimen._14sdp;
		private int bBackgroundResource = R.color.white;
		private boolean bLabelsClickables = DEFAULT_LABELS_CLICKABLES;
		private int bLabelPadding = R.dimen._1sdp;
