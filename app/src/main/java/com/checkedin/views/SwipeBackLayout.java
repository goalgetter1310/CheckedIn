...
import com.checkedin.dialog.SwipeBackDialog;
...
public class SwipeBackLayout extends ViewGroup {
	...
	public SwipeBackLayout(Context context, SwipeBackDialog swipeBackDialog, AttributeSet attrs) {
		super(context, attrs);
		dialog = swipeBackDialog;
		viewDragHelper = ViewDragHelper.create(this, 1.0f, new ViewDragHelperCallBack());
	}

	public SwipeBackLayout(Context context, SwipeBackDialog swipeBackDialog) {
		this(context, swipeBackDialog, null);
	}
