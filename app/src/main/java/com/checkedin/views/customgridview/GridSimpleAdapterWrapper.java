...
public class GridSimpleAdapterWrapper extends BaseAdapter implements
		GridBaseAdapter {
	private GridSimpleAdapter mDelegate;

	private HeaderData[] mHeaders;

	public GridSimpleAdapterWrapper(GridSimpleAdapter adapter) {
		mDelegate = adapter;
	...
	protected HeaderData[] generateHeaderList(GridSimpleAdapter adapter) {
