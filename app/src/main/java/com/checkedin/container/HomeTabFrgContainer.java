...
import com.checkedin.fragment.HomeFrg;
import com.checkedin.fragment.HomeTabFrg;

@SuppressLint({"InflateParams", "ValidFragment"})
public class HomeTabFrgContainer extends BaseContainerFragment {
    private boolean mIsViewInited;
    private Fragment fragment;

    public HomeTabFrgContainer() {
    }

    public HomeTabFrgContainer(Fragment fragment) {
    ...
    private void initView() {
        replaceFragment(new HomeTabFrg(), false);
        if (fragment != null) {
